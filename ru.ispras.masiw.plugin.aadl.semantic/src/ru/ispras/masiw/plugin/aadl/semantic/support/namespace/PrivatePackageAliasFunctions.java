...
public class PrivatePackageAliasFunctions implements Usefull{
	public static void uniquePackageAlias(IExtendedEObject p, IExtendedEObject c,
		...
		if (alias.getPackage().eIsProxy()) {
			...
			if (!(NamespaceModel.localPrivateImports.get(curPackage.getIdentifier())
					.containsKey(alias.getPackage().getIdentifier()) ||
					NamespaceModel.localPublicImports.get(curPackage.getIdentifier())
						.containsKey(alias.getPackage().getIdentifier()))) {
			...
			if (NamespaceModel.localPrivateNamespaces.get(curPackage.getIdentifier()).containsKey(alias.getIdentifier()) || 
					NamespaceModel.localPublicNamespaces.get(curPackage.getIdentifier()).containsKey(alias.getIdentifier()) || 
					NamespaceModel.localPrivateClassifierAliases.get(curPackage.getIdentifier()).containsKey(alias.getIdentifier()) ||
					NamespaceModel.localPublicClassifierAliases.get(curPackage.getIdentifier()).containsKey(alias.getIdentifier()) ||
					NamespaceModel.localPrivatePackageAliases.get(curPackage.getIdentifier()).containsKey(alias.getIdentifier()) ||
			...
			NamespaceModel.localPrivatePackageAliases.get(curPackage.getIdentifier()).put(alias.getIdentifier(), alias);
		}
	}
