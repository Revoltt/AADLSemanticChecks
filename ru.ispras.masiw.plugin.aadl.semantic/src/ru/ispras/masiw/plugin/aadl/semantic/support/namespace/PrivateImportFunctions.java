...
public class PrivateImportFunctions implements Usefull{

	public static void privateDuplicateImport(IExtendedEObject p, IExtendedEObject c,
		...
		if (!(NamespaceModel.globalPackageNamespace.containsKey(importId) || 
			...
			NamespaceModel.localPrivateImports.get(curPackage.getIdentifier()).put(importId, 
